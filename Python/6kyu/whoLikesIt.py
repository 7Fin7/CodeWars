...
def likes(names):
    ...
    if like_count == 0:
        ...
        return f"{names[0]}, {names[1]} and {like_count - 2} others like this"
...
def likes_v2(names):
    ...
    # and subsequently returned. Min is necessary as len(names) may be > 4. Min returns
